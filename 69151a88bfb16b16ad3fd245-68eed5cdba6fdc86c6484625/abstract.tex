...
11/12/2025 & Load Balancer and Virtual Host (GC\&JB\&TU\&SS):
\begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=12pt]
\item Deployed two web servers using Docker and configured Nginx to provide load balancing and name based virtual hosting on a DigitalOcean droplet. (Chapter \ref{Chapter::LoadBalancer}). 
\end{itemize} 
\\ \hline
